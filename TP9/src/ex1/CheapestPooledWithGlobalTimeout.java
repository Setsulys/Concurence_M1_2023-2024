...
public class CheapestPooledWithGlobalTimeout {
	...
	public CheapestPooledWithGlobalTimeout(String item, int timeoutMilliPerRequest,int globalTimeout,int nbThreads) {
		this.item = item;
	...
	public Optional<Answer> retreive(){
		...
		try {
			var futures = executorService.invokeAll(callables,globalTimeout,TimeUnit.MILLISECONDS);
	...
	public static void main(String[] args) {
		var agregator = new CheapestPooledWithGlobalTimeout("pikachu", 2_000,3_000,5);
